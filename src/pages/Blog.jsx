      ...
      <div className="bg-green-100">
        <header className="w-full container mx-auto">
          <div className="flex flex-col items-center py-12">
            ...
            <p className="text-lg text-gray-600 text-center">Disini terdapat beberapa artikel mengenai kesehatan mental yang dapat menambah pemahamanmu tentang kesehatan mental loh!! Yuk cek sekarang</p>
          </div>
        </header>
