    ...
    <>
      ...
      <div className="flex flex-wrap">
        <div className="w-full mt-6 lg:mt-28 px-20 lg:w-1/2">
          ...
          <button className="text-sm font-semibold text-white bg-secondary py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out">Jadwalkan Konsultasi</button>
        </div>
