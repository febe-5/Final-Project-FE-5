  ...
  return (
    <>
      <div className="mx-10 my-10">
        <div className="w-full rounded-lg shadow-md lg:max-w-sm bg-primary "><img className="object-cover w-full h-48 mb-10 rounded-lg" src={props.imgUrl} alt="ini-gambar-guis" />
