      ...
      <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">Fitur</h6>
              <p className="mb-4">Tentang Kami</p>
              <p className="mb-4">Layanan</p>
              <p className="mb-4">Artikel</p>
              <p className="mb-4">Login</p>
            </div>
            <div className="">
              <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">Layanan</h6>
              <p className="mb-4">Online</p>
              <p className="mb-4">Offline</p>
            </div>
            <div className="">
