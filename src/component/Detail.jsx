                ...
                .map((item) => {
                  return (
                    <div key={item._id} className="block p-10 bg-green-100 rounded-lg min-w-full ">
                      ...
                      <a href={"tel:" + item.no_telp} className="text-base font-semibold text-black bg-primary py-3 px-8 rounded-full hover:shadow-lg hover:opacity-80 transition duration-300 ease-in-out justify-center">
                        Jadwalkan Konsultasi
                      </a>
                      <div className="flex lg:flex-row justify-center mt-10">
                        <a href={"Mail to:" + item.email} className="w-12 h-12 mr-4 rounded-full flex justify-center items-center border border-slate-300 hover:border-red-500 hover:bg-red-500 hover:text-white text-slate-300">
                        ...
                        <a href={"Telp:" + item.no_telp} className="w-12 h-12 mr-4 rounded-full flex justify-center items-center border border-slate-300 hover:border-green-400 hover:bg-green-400 hover:text-white text-slate-300">
                          <svg role="img" width="26" className="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
